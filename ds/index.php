...
// $sqlDROP = "DROP DATABASE amazion";
// if (mysqli_query($link, $sqlDROP)) {
//     echo "Database dropped successfully";
// } else {
//     echo "Error creating database: " . mysqli_error($conn);
// }

$sqlDB = "CREATE DATABASE IF NOT EXISTS drawSomething";
...
mysqli_select_db($link, "drawSomething");

$sqlTBL = "CREATE TABLE IF NOT EXISTS `users` (
  `name` varchar(50) NOT NULL,
  `id` int(2) NOT NULL AUTO_INCREMENT,
  `password` varchar(20) NOT NULL,
  PRIMARY KEY (`id`)
)";
if (mysqli_query($link, $sqlTBL)) {
